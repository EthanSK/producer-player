              ...
              <div className="analysis-overlay-grid">
                ...
                <div className="analysis-overlay-side-by-side">
                  ...
                  <section className="analysis-overlay-section">
                    <div className="analysis-section-header">
                      <h4 data-testid="analysis-overlay-tonal-balance-heading">Tonal Balance{refTrackSuffix} <HelpTooltip text="Shows how your audio energy is distributed across three frequency bands. Low (20-250 Hz) covers bass and sub-bass. Mid (250-4000 Hz) covers vocals, guitars, and most melodic content. High (4000-20000 Hz) covers presence, air, and brightness. Each band is shown as a percentage of total energy. If Low is above 40%, your mix may be too bass-heavy. If High is above 30%, it may be too bright. Most balanced masters land around 30-40% Low, 40-50% Mid, and 15-25% High." links={TONAL_BALANCE_LINKS} /></h4>
