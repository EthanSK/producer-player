...
- Downloadable **unsigned macOS ZIP artifacts** from `.github/workflows/release-desktop.yml`
...
If signing is not configured, keep shipping unsigned macOS ZIP artifacts from CI so users can download and test immediately.
